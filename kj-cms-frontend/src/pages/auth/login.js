...
import { LoginAPI, baseUrl, loginAPI } from "src/config/api";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      ...
      try {
        ...
        // const resp = res.data;
        let res = await axios.post(LoginAPI, { email: values.email, password: values.password })
        console.log(res, "LOGINRES")

        setUserDetailsStore(res.data);
          ...
          <div>
            ...
            {method === "email" && (
              <form noValidate onSubmit={formik.handleSubmit}>
                ...
                <Button fullWidth size="large" sx={{ mt: 3, backgroundColor: '#A02929' }} type="submit" variant="contained">
                  Continue
                </Button>
              </form>
            )}
